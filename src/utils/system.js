...
export const SCREENS_NAME = {
  ...
  RoomCurrentReservationDetails: "RoomCurrentReservationDetails",
  ReservationsRequests: "ReservationsRequests",
...
export const ShowToastMessage = (
  ...
  Toast.show(message, {
    ...
    //shadow: true,
    // opacity: 1,
    //shadowColor: DEFAULT_STYLES.DEFAULT_COLOR.color,
    animation: true,
    //hideOnPress: true,
    delay: 0,
    backgroundColor,
...
export const ERoomPriceDescription = {
  DAY: "Journée (24H)",
